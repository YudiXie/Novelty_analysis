...
for folderi=1:folderlen
    ...
    for filei = 2:flen
        ...
        clearvars -except filelist flen filei Time_angle Time_distance startframe endframe folderi folderlen foldernames write_pointer TableName Time_distance_all Time_angle_all DisOrAng
    end
