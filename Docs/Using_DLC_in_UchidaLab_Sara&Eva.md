...
Rename this configeration file to `myconfig_analysis.py` and replace the existing file. Also save a copy of this file with name `myconfig_analysis (EvaNovelty).py` for your future use.
