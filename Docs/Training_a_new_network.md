...
```
7. Evaluate your network, (run this code inside the Evaluation-tools folder)
```
...
Edit: `myconfig_analysis.py` file at the main DeepLabCut folder

1. AnalyzingVideos, (run this code inside the Analysis-tools folder)
```
